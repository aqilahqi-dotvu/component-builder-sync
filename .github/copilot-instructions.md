...
| `font-settings`           | Adding the standard Typography settings block (Font Family, Weight, Size, Line Height, Alignment, Color) in a 2×2 grid whenever a component has a TextInput or textarea |
